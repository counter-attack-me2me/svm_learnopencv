...
Mat deskew(Mat& img){
    ...
    // NOTE 为什么这么定义 
    // cout << "C = " << endl << " " << warpMat << endl << endl;
    // Mat RowClone = warpMat.row(1).clone();
    // cout << "RowClone = " << endl << " " << RowClone << endl << endl;

    Mat imgOut =
        Mat::zeros(img.rows, img.cols, img.type());
